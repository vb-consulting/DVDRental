...
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-actor-actor_id" href="#public-actor-actor_id">#</a>**`actor_id`** | **PK** | `integer`| **NO** | `nextval('actor_actor_id_seq'::regclass)` | <!-- comment on column "public"."actor"."actor_id" is @until-end-tag; --><!-- end --> |
| <a id="user-content-public-actor-first_name" href="#public-actor-first_name">#</a>`first_name` |  | `character varying(45)`| **NO** |  | <!-- comment on column "public"."actor"."first_name" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-address-address_id" href="#public-address-address_id">#</a>**`address_id`** | **PK** | `integer`| **NO** | `nextval('address_address_id_seq'::regclass)` | <!-- comment on column "public"."address"."address_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-category-category_id" href="#public-category-category_id">#</a>**`category_id`** | **PK** | `integer`| **NO** | `nextval('category_category_id_seq'::regclass)` | <!-- comment on column "public"."category"."category_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-city-city_id" href="#public-city-city_id">#</a>**`city_id`** | **PK** | `integer`| **NO** | `nextval('city_city_id_seq'::regclass)` | <!-- comment on column "public"."city"."city_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-country-country_id" href="#public-country-country_id">#</a>**`country_id`** | **PK** | `integer`| **NO** | `nextval('country_country_id_seq'::regclass)` | <!-- comment on column "public"."country"."country_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-customer-customer_id" href="#public-customer-customer_id">#</a>**`customer_id`** | **PK** | `integer`| **NO** | `nextval('customer_customer_id_seq'::regclass)` | <!-- comment on column "public"."customer"."customer_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-film-film_id" href="#public-film-film_id">#</a>**`film_id`** | **PK** | `integer`| **NO** | `nextval('film_film_id_seq'::regclass)` | <!-- comment on column "public"."film"."film_id" is @until-end-tag; --><!-- end --> |
...
| <a id="user-content-public-film-rental_rate" href="#public-film-rental_rate">#</a>`rental_rate` |  | `numeric(4,2)`| **NO** | `4.99` | <!-- comment on column "public"."film"."rental_rate" is @until-end-tag; --><!-- end --> |
...
| <a id="user-content-public-film-replacement_cost" href="#public-film-replacement_cost">#</a>`replacement_cost` |  | `numeric(5,2)`| **NO** | `19.99` | <!-- comment on column "public"."film"."replacement_cost" is @until-end-tag; --><!-- end --> |
| <a id="user-content-public-film-rating" href="#public-film-rating">#</a>`rating` |  | `mpaa_rating` <sub>user defined `AS ENUM ('G', 'PG', 'PG-13', 'R', 'NC-17')` [➝](#enum-public-mpaa_rating)</sub>| YES | `'G'::mpaa_rating` | <!-- comment on column "public"."film"."rating" is @until-end-tag; --><!-- end --> |
...
| <a id="user-content-public-film-special_features" href="#public-film-special_features">#</a>`special_features` |  | `text[]`| YES |  | <!-- comment on column "public"."film"."special_features" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-film_actor-actor_id" href="#public-film_actor-actor_id">#</a>`actor_id` | **FK [➝](#public-actor-actor_id) `actor.actor_id`** | `smallint`| **NO** |  | <!-- comment on column "public"."film_actor"."actor_id" is @until-end-tag; --><!-- end --> |
| <a id="user-content-public-film_actor-actor_id" href="#public-film_actor-actor_id">#</a>**`actor_id`** | **PK** | `smallint`| **NO** |  | <!-- comment on column "public"."film_actor"."actor_id" is @until-end-tag; --><!-- end --> |
| <a id="user-content-public-film_actor-film_id" href="#public-film_actor-film_id">#</a>`film_id` | **FK [➝](#public-film-film_id) `film.film_id`**, **IDX** | `smallint`| **NO** |  | <!-- comment on column "public"."film_actor"."film_id" is @until-end-tag; --><!-- end --> |
| <a id="user-content-public-film_actor-film_id" href="#public-film_actor-film_id">#</a>**`film_id`** | **PK** | `smallint`| **NO** |  | <!-- comment on column "public"."film_actor"."film_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-film_category-film_id" href="#public-film_category-film_id">#</a>`film_id` | **FK [➝](#public-film-film_id) `film.film_id`** | `smallint`| **NO** |  | <!-- comment on column "public"."film_category"."film_id" is @until-end-tag; --><!-- end --> |
| <a id="user-content-public-film_category-film_id" href="#public-film_category-film_id">#</a>**`film_id`** | **PK** | `smallint`| **NO** |  | <!-- comment on column "public"."film_category"."film_id" is @until-end-tag; --><!-- end --> |
| <a id="user-content-public-film_category-category_id" href="#public-film_category-category_id">#</a>`category_id` | **FK [➝](#public-category-category_id) `category.category_id`** | `smallint`| **NO** |  | <!-- comment on column "public"."film_category"."category_id" is @until-end-tag; --><!-- end --> |
| <a id="user-content-public-film_category-category_id" href="#public-film_category-category_id">#</a>**`category_id`** | **PK** | `smallint`| **NO** |  | <!-- comment on column "public"."film_category"."category_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-inventory-inventory_id" href="#public-inventory-inventory_id">#</a>**`inventory_id`** | **PK** | `integer`| **NO** | `nextval('inventory_inventory_id_seq'::regclass)` | <!-- comment on column "public"."inventory"."inventory_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-language-language_id" href="#public-language-language_id">#</a>**`language_id`** | **PK** | `integer`| **NO** | `nextval('language_language_id_seq'::regclass)` | <!-- comment on column "public"."language"."language_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-payment-payment_id" href="#public-payment-payment_id">#</a>**`payment_id`** | **PK** | `integer`| **NO** | `nextval('payment_payment_id_seq'::regclass)` | <!-- comment on column "public"."payment"."payment_id" is @until-end-tag; --><!-- end --> |
...
| <a id="user-content-public-payment-amount" href="#public-payment-amount">#</a>`amount` |  | `numeric(5,2)`| **NO** |  | <!-- comment on column "public"."payment"."amount" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-rental-rental_id" href="#public-rental-rental_id">#</a>**`rental_id`** | **PK** | `integer`| **NO** | `nextval('rental_rental_id_seq'::regclass)` | <!-- comment on column "public"."rental"."rental_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-staff-staff_id" href="#public-staff-staff_id">#</a>**`staff_id`** | **PK** | `integer`| **NO** | `nextval('staff_staff_id_seq'::regclass)` | <!-- comment on column "public"."staff"."staff_id" is @until-end-tag; --><!-- end --> |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-store-store_id" href="#public-store-store_id">#</a>**`store_id`** | **PK** | `integer`| **NO** | `nextval('store_store_id_seq'::regclass)` | <!-- comment on column "public"."store"."store_id" is @until-end-tag; --><!-- end --> |
...
| `price` | `numeric(4,2)`| <!-- comment on column "public"."film_list"."price" is @until-end-tag; --><!-- end --> |
| `length` | `smallint`| <!-- comment on column "public"."film_list"."length" is @until-end-tag; --><!-- end --> |
| `rating` | `mpaa_rating` <sub>user defined `AS ENUM ('G', 'PG', 'PG-13', 'R', 'NC-17')` [➝](#enum-public-mpaa_rating)</sub>| <!-- comment on column "public"."film_list"."rating" is @until-end-tag; --><!-- end --> |
...
| `price` | `numeric(4,2)`| <!-- comment on column "public"."nicer_but_slower_film_list"."price" is @until-end-tag; --><!-- end --> |
| `length` | `smallint`| <!-- comment on column "public"."nicer_but_slower_film_list"."length" is @until-end-tag; --><!-- end --> |
| `rating` | `mpaa_rating` <sub>user defined `AS ENUM ('G', 'PG', 'PG-13', 'R', 'NC-17')` [➝](#enum-public-mpaa_rating)</sub>| <!-- comment on column "public"."nicer_but_slower_film_list"."rating" is @until-end-tag; --><!-- end --> |
...
| --------- | ------ | --------|
| <a id="user-content-enum-public-mpaa_rating" href="#enum-public-mpaa_rating">#</a>`public.mpaa_rating` | `'G', 'PG', 'PG-13', 'R', 'NC-17'` | <!-- comment on type "public"."mpaa_rating" is @until-end-tag; --><!-- end --> |
...
<!-- comment on function "public"."_group_concat"() is @until-end-tag; -->
<!-- end -->
...
<!-- comment on function "public"."film_in_stock"(p_film_id integer, p_store_id integer) is @until-end-tag; -->
<!-- end -->
...
<!-- comment on function "public"."film_not_in_stock"(p_film_id integer, p_store_id integer) is @until-end-tag; -->
<!-- end -->
...
<!-- comment on function "public"."get_customer_balance"(p_customer_id integer, p_effective_date timestamp without time zone) is @until-end-tag; -->
<!-- end -->
...
<!-- comment on function "public"."inventory_held_by_customer"(p_inventory_id integer) is @until-end-tag; -->
<!-- end -->
...
<!-- comment on function "public"."inventory_in_stock"(p_inventory_id integer) is @until-end-tag; -->
<!-- end -->
...
<!-- comment on function "public"."last_day"() is @until-end-tag; -->
<!-- end -->
...
<!-- comment on function "public"."rewards_report"(min_monthly_purchases integer, min_dollar_amount_purchased numeric) is @until-end-tag; -->
<!-- end -->
